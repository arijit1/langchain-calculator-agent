...
// config();
// //Bind Tool to LLM and run one agent loop
...
//     { tool_choice: "any" } // any/required optional. forces to use tool
// );
...
//     console.log("📥 Model raw response:", JSON.stringify(first, null, 2));

//     if (!first.tool_calls?.length) {
//         console.log("✅ No tool calls. Final Answer:", first.content);
//         return;
//     }
//     console.log("🛠️ Model requested tool calls:", first.tool_calls);

//     const toolMsgs = await Promise.all(
//         first.tool_calls.map(async (call) => {
//             console.log(`⚡ Running tool: ${call.name} with args`, call.args);
